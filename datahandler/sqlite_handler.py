...
# create sitters
# data_manager.add_sitter(new_sitter_data={"first_name": "Emily", "last_name": "Johnson", "email": "emily.johnson@example.com"})
# data_manager.add_sitter(new_sitter_data={"first_name": "David", "last_name": "Wilson", "email": "david.wilson@example.com"})
# data_manager.add_sitter(new_sitter_data={"first_name": "Sarah", "last_name": "Davis", "email": "sarah.davis@example.com"})
