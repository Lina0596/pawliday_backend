...
# data_manager.add_sitter({"first_name": "Max", "last_name": "Mustermann", "email": "max.mustermann@example.com"})

# create owners
# data_manager.add_owner(sitter_id=1, {"first_name": "Leo", "last_name": "Storm", "email": "leo.storm@example.com", "phone_number": "+49 163 2438301"})
# data_manager.add_owner(sitter_id=1, {"first_name": "Finn", "last_name": "Wilder", "email": "finn.wilder@example.com", "phone_number": "+49 177 8297922"})
# data_manager.add_owner(sitter_id=1, {"first_name": "Zara", "last_name": "Nightshade", "email": "zara.nightshade@example.com", "phone_number": "+49 178 7069665"})
# data_manager.add_owner(sitter_id=1, {"first_name": "Ivy", "last_name": "Blackthorn", "email": "maya.blackthorn@example.com", "phone_number": "+49 175 6341714"})
# data_manager.add_owner(sitter_id=2, {"first_name": "Kai", "last_name": "Ironhart", "email": "kai.ironhart@example.com", "phone_number": "+49 171 0006303"})
# data_manager.add_owner(sitter_id=2, {"first_name": "Nova", "last_name": "Winters", "email": "nova.winters@example.com", "phone_number": "+49 151 3903711"})
# data_manager.add_owner(sitter_id=2, {"first_name": "Selene", "last_name": "Shadowbrook", "email": "selene.shadowbrook@example.com", "phone_number": "+49 170 1373380"})
